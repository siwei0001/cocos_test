  ...
  ready() {
    ...
    const app = new window.Vue({
      ...
      data: {
        ...
        expandLabel: translate('expand'),
        expandTooltipLabel: translate('expandTooltip'),
        detailLabel: translate('detail'),
        detailTooltipLabel: translate('detailTooltip'),
